...
abstract class TweetSet {
  ...
  /**
    ...
    * and be implemented in the subclasses?
    */
  def descendingByRetweet: TweetList = if (this.isEmpty) Nil else new Cons(this.mostRetweeted, this.remove(this.mostRetweeted).descendingByRetweet)
...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  def mostRetweeted: Tweet = {
    ...
    foreach((elem) => if (elem.retweets > mostRetweeted.retweets) mostRetweeted = elem)
    elem
  }
